-- Settled 关台结账: cancel unpaid splits, close session, preserve orders.
-- Do not invent whole-table paid split / collected_payments — closed session
-- revenue uses preserved order totals (sessionRevenue).
