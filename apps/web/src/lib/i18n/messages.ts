...
export const MESSAGES = {
  ...
  en: {
    nav: { overview: 'Overview', tables: 'Tables', unpaidOrders: 'Active orders', checkout: 'Checkout requests', printAssistant: 'Print assistant', menu: 'Menu', buffet: 'Buffet pricing', orders: 'Paid orders', settings: 'Settings', viewKitchen: 'Open kitchen display', viewWaiter: 'Open waiter board', logout: 'Log out' },
    buffetAdmin: {
  ...
  pt: {
    nav: { overview: 'Visao geral', tables: 'Mesas', unpaidOrders: 'Pedidos ativos', checkout: 'Solicitacoes de fechamento', printAssistant: 'Assistente de impressao', menu: 'Gestao do menu', buffet: 'Precos buffet', orders: 'Pedidos pagos', settings: 'Configuracoes', viewKitchen: 'Abrir tela da cozinha', viewWaiter: 'Abrir painel do garcom', logout: 'Sair' },
    buffetAdmin: {
