export const WAITER_TEXT = {
  zh: {
    ...
    checkoutPinnedAlsoInPartyHint: '另有 {n} 桌待结账在 Together 组内',
    partySectionTitle: '{name} · {n} 桌',
    partySectionCheckoutHint: '含 {n} 待结账',
    partyCreate: '创建 Together 组',
    partyCreating: '创建中…',
    partyAddTables: '添加桌',
    partyRemoveTable: '移出',
    partyDissolve: '解散',
    partyDissolveConfirm: '解散该 Together 组？桌位会回到下方列表。',
    partyAddTitle: '添加桌到 Together 组',
    partyAddHint: '任意状态都可加入；已在其他 Together 组的桌需确认后移入。',
    partyAddConfirm: '加入本组',
    partyAddOperating: '加入中…',
    partyMoveConfirmTitle: '桌位已在其他 Together 组',
    partyMoveConfirmMessage: '确认将 {tables} 移入本组？',
    partyMoveConfirmButton: '确认移入',
    partyEmpty: '还没有桌，点「添加桌」把一拨客人标在一起。',
    partyCreateFailed: '创建 Together 组失败',
  ...
  en: {
    ...
    partyAddHint: 'Any status can join; tables already in another group need confirmation.',
  ...
  pt: {
    ...
    partyAddHint: 'Qualquer estado pode entrar; mesas noutro grupo pedem confirmacao.',
