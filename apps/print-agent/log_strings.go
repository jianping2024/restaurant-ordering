...
func logStringsZH() map[string]string {
	return map[string]string{
		...
		"log_pending_jobs_error":    "无法连接 MesaGo 拉取打印任务",
...
func logStringsEN() map[string]string {
	return map[string]string{
		...
		"log_pending_jobs_error":    "Cannot reach MesaGo to fetch print jobs",
...
func logStringsPT() map[string]string {
	return map[string]string{
		...
		"log_pending_jobs_error":    "Sem ligação ao MesaGo para obter trabalhos",
		...
		"log_station_maps_cleared":  "Removido todo o mapeamento (este PC deixa de receber impressões)",
