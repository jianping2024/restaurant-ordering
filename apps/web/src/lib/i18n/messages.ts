...
export const MESSAGES = {
  zh: {
    ...
    checkout: {
      ...
      discountIncomplete: '请先完成折扣设置（填写折扣原因）',
  ...
  en: {
    ...
    checkout: {
      ...
      discountIncomplete: 'Complete the discount setup first (select a discount reason).',
  ...
  pt: {
    ...
    checkout: {
      ...
      discountIncomplete: 'Conclua primeiro a configuracao do desconto (selecione o motivo).',
