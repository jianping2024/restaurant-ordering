export const WAITER_TEXT = {
  zh: {
    ...
    partyRemoveTable: '移出',
    partyDissolve: '解散',
    partyDissolveConfirm: '解散该同行组？桌位会回到下方列表。',
  ...
  en: {
    ...
    partyCreate: 'Create together-group',
    ...
    partyDissolveConfirm: 'Dissolve this together-group? Tables return to the list below.',
  ...
  pt: {
    ...
    partyCreate: 'Criar grupo juntos',
    ...
    partyDissolveConfirm: 'Dissolver este grupo? As mesas voltam a lista abaixo.',
