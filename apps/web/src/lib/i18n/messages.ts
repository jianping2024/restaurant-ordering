...
export const MESSAGES = {
  zh: {
    ...
    checkout: {
      ...
      resumeOrderingConfirmPreserveByItem:
        '客人可继续点单。按菜分单方案将保留；已有菜品归属不可改，新菜可继续分配。',
    ...
    bill: {
      ...
      splitPlanLocked: '分单方案已锁定；已有分配不可改，新菜可继续分配。',
  ...
  en: {
    ...
    checkout: {
      ...
      resumeOrderingConfirmPreserveByItem:
        'Guests can order again. The by-item split is kept; existing allocations stay fixed and only new dishes can be assigned.',
      resumeOrderingConfirmPreserveWithCollections:
  ...
  pt: {
    ...
    checkout: {
      ...
      resumeOrderingConfirmPreserveByItem:
        'Os clientes podem voltar a pedir. A divisao por prato mantem-se; atribuicoes existentes ficam fixas e so novos pratos podem ser atribuidos.',
      resumeOrderingConfirmPreserveWithCollections:
