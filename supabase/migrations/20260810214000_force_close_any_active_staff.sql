-- Force-close manual: any active staff (or restaurant owner). App enforces tables.force_close;
-- closed_reason (cashier_forced / frontdesk_forced / …) is audit only — not a second role gate.
...
COMMENT ON FUNCTION public.close_table_session_manual(
  ...
  'Manual unpaid/force close. Operator: restaurant owner_id or any active staff. App enforces tables.force_close.';
