...
export const MESSAGES = {
  zh: {
    ...
    featureSettings: {
      title: '功能管理',
      desc: '控制后台侧栏与快捷入口中显示的可选功能。未勾选的功能不会在主页侧栏出现。',
