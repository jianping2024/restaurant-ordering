...
func logStringsZH() map[string]string {
	return map[string]string{
		...
		"log_skipped_offline_backlog": "已跳过打印机恢复前的积压任务（单号 %s）",
		"log_printer_not_ready":     "打印机离线或不可达，稍后重试",
...
func logStringsEN() map[string]string {
	return map[string]string{
		...
		"log_skipped_offline_backlog": "Skipped backlog before printer came online (id %s)",
		"log_printer_not_ready":     "Printer offline or unreachable; will retry",
...
func logStringsPT() map[string]string {
	return map[string]string{
		...
		"log_skipped_offline_backlog": "Ignorado backlog antes da impressora ficar online (id %s)",
		"log_printer_not_ready":     "Impressora offline ou inacessível; a tentar de novo",
