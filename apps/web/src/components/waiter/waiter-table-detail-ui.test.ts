...
test('page identity and ordered-items share one sticky chrome stack', () => {
  ...
  assert.match(waiterDetailLayout.orderedItemsMoneyChrome, /flex-col/);
  assert.match(waiterDetailLayout.orderedItemsMoneyChrome, /items-center/);
  assert.match(waiterDetailLayout.orderedItemsMoneyChrome, /sm:flex-row/);
  assert.match(waiterDetailLayout.orderedItemsMoneyChrome, /sm:justify-end/);
  ...
  assert.match(waiterDetailLayout.orderedItemsMoneyLine, /text-lg/);
  assert.match(waiterDetailLayout.orderedItemsMoneyLine, /tabular-nums/);
  assert.match(waiterDetailLayout.orderedItemsMoneyLine, /text-center/);
  assert.match(waiterDetailLayout.orderedItemsPreBillAction, /whitespace-nowrap/);
  assert.match(waiterDetailLayout.orderedItemsPreBillAction, /shrink-0/);
...
test('ordered-items panel splits money chrome from list title (one representation)', async () => {
  ...
  assert.doesNotMatch(panel, /sessionTotalText/);
  assert.doesNotMatch(panel, /orderedItemsTotal/);
