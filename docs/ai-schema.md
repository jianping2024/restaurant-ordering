...
table_party_groups (id: uuid PK, restaurant_id: uuid FK -> restaurants.id, name: text length 1..32 unique per restaurant case-insensitive trim, sort_order: integer, created_at: timestamptz)
