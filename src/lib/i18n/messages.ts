...
export const MESSAGES = {
  zh: {
    ...
    tables: {
      ...
      tableQrDesc: '顾客扫码进入对应桌号的点餐页；调整数量后打印或逐张下载。',
      count: '桌位数量（1-30）',
      table: '桌',
      download: '下载二维码',
      staffTitle: '员工登录二维码',
