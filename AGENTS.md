...
- **Menu dish list row:** sole on-screen title `formatMenuCatalogItemLabel`; trailing sole `€` + availability toggle + `MenuItemListRowOverflowMenu` (edit/delete). Do not pack PT·EN·ZH into one truncate line or put inline ✎/× beside the toggle.
