...
export const MESSAGES = {
  zh: {
    ...
    menuManager: {
      ...
      guideStep3: '③ 「出品档口」Tab：定义后厨、吧台等窗口，再在分类或菜品上绑定；分类留空表示不出档口出品联。',
      addItem: '添加菜品',
      allOn: '本页全部上架',
      allOff: '本页全部下架',
    ...
    settingsHub: {
      ...
      hintShow: '查看说明',
      hintHide: '收起说明',
      hintProfile: '餐厅名称、地址、经纬度、允许下单距离（米）与厨房/楼面 PIN。',
  ...
  en: {
    ...
    menuManager: {
      ...
      guideStep3: '③ Print stations tab: define kitchen, bar, etc., then bind on categories or dishes. Empty on a category means no station ticket.',
      addItem: 'Add dish',
    ...
    settingsHub: {
      ...
      hintHide: 'Hide guide',
      hintProfile:
        'Restaurant name, address, coordinates, max order distance (m), and kitchen/waiter PINs.',
  ...
  pt: {
    ...
    menuManager: {
      ...
      guideStep3: '③ Separador Estacoes: defina cozinha, bar, etc., e associe nas categorias ou pratos. Vazio = sem talao de estacao.',
    ...
    settingsHub: {
      ...
      hintProfile:
        'Nome, morada, coordenadas, distancia maxima de pedido (m) e PINs de cozinha/sala.',
      hintTables:
