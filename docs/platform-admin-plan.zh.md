# Farvoo 平台运营后台（Platform Admin）实施计划

> **状态**：规划稿（2026-06-23）  
> **受众**：Farvoo 团队内部运营 / 技术支持  
...
**目标**：建设 **Farvoo 平台运营后台**（下文简称 **运营后台**），统一上述能力；逐步 **收口** 裸注册页，仅保留受控 bootstrap 或完全下线。

## 2. 角色与边界（已定）

| 维度 | **平台运营** | **店主 `/dashboard`** | **店内员工** |
|------|----------------|----------------------|--------------|
| 身份 | Farvoo 内部运营 / 支持账号 | `restaurants.owner_id` | `{login_name}@mesa.in` |
