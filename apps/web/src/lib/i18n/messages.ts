...
export const MESSAGES = {
  ...
  en: {
    ...
    dashboard: { title: 'Overview', todayOrders: 'Orders today', todayRevenue: 'Revenue today', doneOrders: 'Completed today', menuCount: 'Menu items', unitOrder: '', unitDish: '', topItems: 'Top dishes today', noToday: 'No orders today', recent: 'Recent orders', noOrders: 'No orders yet', table: 'Table', serving: '' },
  ...
  pt: {
    ...
    dashboard: { title: 'Visao geral', todayOrders: 'Pedidos hoje', todayRevenue: 'Faturamento hoje', doneOrders: 'Concluidos hoje', menuCount: 'Itens do menu', unitOrder: '', unitDish: '', topItems: 'Pratos populares hoje', noToday: 'Sem pedidos hoje', recent: 'Pedidos recentes', noOrders: 'Sem pedidos', table: 'Mesa', serving: '' },
