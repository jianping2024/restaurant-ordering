export const WAITER_TEXT = {
  zh: {
    ...
    buffetPricePreviewLine: '成人 {adultPrice} €/人 · 儿童 {childPrice} €/人 · 合计约 {total} €',
    buffetApply: '开台',
  ...
  en: {
    ...
    buffetPricePreviewLine: 'Adult {adultPrice} € · Child {childPrice} € · Est. {total} €',
  ...
  pt: {
    ...
    buffetPricePreviewLine: 'Adulto {adultPrice} € · Crianca {childPrice} € · Total ~{total} €',
