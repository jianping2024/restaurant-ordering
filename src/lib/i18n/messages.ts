...
export const MESSAGES = {
  zh: {
    ...
    menuManager: {
      ...
      addRootShort: '新增大类',
      addChild: '新增子分类',
      categoryTreeHint: '点击分类名称即可在右侧编辑；也可用行内按钮新增子类或删除。',
  ...
  en: {
    ...
    menuManager: {
      ...
      categoryTreeHint: 'Click a category name to edit on the right; use inline actions to add a child or delete.',
      ...
      panelEmpty: 'Click a category on the left, or add a root category below.',
  ...
  pt: {
    ...
    menuManager: {
      ...
      categoryTreeHint: 'Clique no nome para editar; use as acoes inline para subcategoria ou eliminar.',
      ...
      panelEmpty: 'Clique numa categoria ou adicione uma raiz abaixo.',
