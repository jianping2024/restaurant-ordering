export const WAITER_TEXT = {
  ...
  en: {
    ...
    cardActionOpenTable: 'Tap to open table',
    cardActionViewOrder: 'View order',
    cardActionViewDetail: 'View details',
    cardActionCheckout: 'Go to checkout',
  },
  pt: {
    ...
    cardActionOpenTable: 'Clique para abrir mesa',
    cardActionViewOrder: 'Ver pedido',
    cardActionViewDetail: 'Ver detalhes',
    cardActionCheckout: 'Ir para checkout',
  },
} as const;
