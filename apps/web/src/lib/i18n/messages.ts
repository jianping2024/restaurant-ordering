...
export const MESSAGES = {
  zh: {
    ...
    orderHistory: {
      ...
      closeTableUnpaidReasonMessage: '该桌尚有未收款项。请选择关台原因后继续。',
