...
export const MESSAGES = {
  zh: {
    ...
    printAssistant: {
      ...
      devicesEmpty: '尚无已配对设备。生成配对码并在收银电脑上完成配对后，此处会显示在线状态。',
      devicesRefresh: '刷新',
  ...
  en: {
    ...
    printAssistant: {
      ...
      devicesEmpty: 'No paired devices yet. Pair a register PC to see status here.',
  ...
  pt: {
    ...
    printAssistant: {
      ...
      devicesEmpty: 'Nenhum dispositivo emparelhado. Emparelhe um PC de caixa para ver o estado aqui.',
