...
export const MESSAGES = {
  zh: {
    ...
    tables: {
      ...
      tableQrDesc: '顾客扫码进入对应桌号的点餐页；可调整数量并自定义每张桌的桌号，保存后生效。',
      count: '桌位数量（1-200）',
      tableNumberLabel: '桌号',
      saveTables: '保存桌位设置',
      savingTables: '保存中…',
      ...
      invalidTableNumber: '桌号须为 1–9999 的整数',
