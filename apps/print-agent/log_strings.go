...
func logStringsZH() map[string]string {
	return map[string]string{
		...
		"log_skipped_offline_backlog": "已跳过打印机恢复前的积压（单号 %s，打印机 %s）",
		"log_printer_not_ready":     "打印机不可达 [%s]：%s",
		...
		"log_skipped_offline_backlog_no_time": "跳过积压（任务无 created_at，单号 %s，打印机 %s）",
		"log_printing_job":          "开始打印：单号 %s，类型 %s，打印机 %s",
		...
		"log_print_failed":          "打印失败（单号 %s，%s）：%s",
...
func logStringsEN() map[string]string {
	return map[string]string{
		...
		"log_skipped_offline_backlog": "Skipped pre-reconnect backlog (id %s, printer %s)",
		"log_printer_not_ready":     "Printer not reachable [%s]: %s",
		...
		"log_skipped_offline_backlog_no_time": "Skipped backlog (job missing created_at, id %s, printer %s)",
		"log_printing_job":          "Printing: id %s, type %s, printer %s",
		...
		"log_route_error":           "Job routing failed (id %s): %s",
		...
		"log_print_failed":          "Print failed (id %s, %s): %s",
...
func logStringsPT() map[string]string {
	return map[string]string{
		...
		"log_skipped_offline_backlog": "Ignorado backlog pré-religação (id %s, impressora %s)",
		"log_printer_not_ready":     "Impressora inacessível [%s]: %s",
		...
		"log_skipped_offline_backlog_no_time": "Ignorado backlog (sem created_at, id %s, %s)",
		"log_printing_job":          "A imprimir: id %s, tipo %s, impressora %s",
		...
		"log_route_error":           "Falha de encaminhamento (id %s): %s",
		...
		"log_print_failed":          "Falha de impressão (id %s, %s): %s",
