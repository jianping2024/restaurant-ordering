...
function errorMessage(code: string, t: StaffSettingsCopy): string {
  const map: Record<string, string> = {
    ...
    password_short: t.errPasswordShort,
    password_too_short: t.errPasswordShort,
    password_need_letter_digit: t.errPasswordNeedLetterDigit,
    password_weak: t.errPasswordWeak,
    password_matches_login: t.errPasswordMatchesLogin,
