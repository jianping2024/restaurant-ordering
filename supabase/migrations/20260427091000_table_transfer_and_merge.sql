-- ============================================================
-- Table transfer + table merge workflow
-- ============================================================

alter table public.table_sessions
  add column if not exists merge_into_session_id uuid references public.table_sessions(id) on delete set null,
  add column if not exists closed_reason text;

create index if not exists idx_table_sessions_merge_into
  on public.table_sessions(merge_into_session_id);
