...
export const MESSAGES = {
  ...
  en: {
    nav: { overview: 'Overview', tables: 'Table setup', unpaidOrders: 'Active orders', checkout: 'Checkout requests', printAssistant: 'Print assistant', menu: 'Menu', buffet: 'Buffet pricing', orders: 'Paid orders', settings: 'Settings', abnormalOps: 'Abnormal ops', viewKitchen: 'Open kitchen display', viewWaiter: 'Waiter board', logout: 'Log out' },
    buffetAdmin: {
  ...
  pt: {
    nav: { overview: 'Visao geral', tables: 'Config. mesas', unpaidOrders: 'Pedidos ativos', checkout: 'Solicitacoes de fechamento', printAssistant: 'Assistente de impressao', menu: 'Gestao do menu', buffet: 'Precos buffet', orders: 'Pedidos pagos', settings: 'Configuracoes', abnormalOps: 'Operacoes anormais', viewKitchen: 'Abrir tela da cozinha', viewWaiter: 'Painel do garcom', logout: 'Sair' },
    buffetAdmin: {
