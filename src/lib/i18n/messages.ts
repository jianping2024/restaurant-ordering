...
export const MESSAGES = {
  zh: {
    ...
    menuManager: {
      ...
      addRootShort: '新增大类',
      addChild: '新增子分类',
      categoryTreeHint: '点击名称在右侧编辑；悬停或选中行显示操作按钮。',
  ...
  en: {
    ...
    menuManager: {
      ...
      categoryTreeHint: 'Click a name to edit on the right; hover or select a row for actions.',
  ...
  pt: {
    ...
    menuManager: {
      ...
      categoryTreeHint: 'Clique no nome para editar; passe o rato ou selecione a linha para acoes.',
