-- RBAC: custom staff as close operators (app enforces tables.force_close); backfill role_id.
...
COMMENT ON FUNCTION public.close_table_session_manual(
  ...
  'Manual unpaid/force close. Operator: restaurant owner_id or active staff role frontdesk|owner|custom. App enforces tables.force_close.';
