export const WAITER_TEXT = {
  zh: {
    ...
    partyMarkerOnlyHint: '看板标记；组内桌不可自己转台/并台，并台目标也不含组内桌',
  ...
  en: {
    ...
    partyMarkerOnlyHint: 'Board marker; tables in a group cannot transfer/merge themselves, and merge targets exclude group tables',
  ...
  pt: {
    ...
    partyMarkerOnlyHint: 'Marcacao no quadro; mesas no grupo nao podem trocar/unir sozinhas, e uniao exclui mesas do grupo',
