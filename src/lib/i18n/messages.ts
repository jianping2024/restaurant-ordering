...
export const MESSAGES = {
  zh: {
    ...
    menuManager: {
      ...
      addRootShort: '新增大类',
      addChild: '新增子分类',
      categoryTreeHint: '点击名称在右侧编辑；鼠标移到分类行或选中后，下方会出现 ＋子类、编辑、删除。',
  ...
  en: {
    ...
    menuManager: {
      ...
      categoryTreeHint: 'Click a name to edit on the right; hover or select a row to show + sub, edit, and delete below.',
  ...
  pt: {
    ...
    menuManager: {
      ...
      categoryTreeHint: 'Clique no nome para editar; ao passar o rato ou selecionar, aparecem + sub, editar e eliminar.',
