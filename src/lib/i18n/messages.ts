...
export const MESSAGES = {
  zh: {
    ...
    printAssistant: {
      ...
      downloadVersionHint:
        '安装包对应版本 {version}（GitHub Release print-agent-v{version}）。安装目录有 VERSION.txt，或运行 MesaPrintAgent.exe -version 核对。',
      downloadSubtitle:
  ...
  en: {
    ...
    printAssistant: {
      ...
      downloadVersionBadge: 'v{version}',
      downloadVersionHint:
        'Installer matches Mesa Print Agent {version} (GitHub Release print-agent-v{version}). Check VERSION.txt in the install folder or run MesaPrintAgent.exe -version.',
      downloadSubtitle:
    ...
    checkout: { title: 'Checkout Requests', empty: 'No pending checkout requests', table: 'Table', amount: 'Amount', discountRate: 'Discount (%)', finalAmount: 'Payable', splitResult: 'Split result', confirmOnePaid: 'Confirm paid', unfinishedOrders: 'There are unfinished dishes; table cannot be closed yet', confirmPaid: 'Confirm payment and close table', processing: 'Processing...', requested: 'Requested', paid: 'Paid' },
  ...
  pt: {
    ...
    printAssistant: {
      ...
      downloadVersionBadge: 'v{version}',
      downloadVersionHint:
        'Instalador versao {version} (GitHub Release print-agent-v{version}). Pasta de instalacao inclui VERSION.txt ou execute MesaPrintAgent.exe -version.',
      downloadSubtitle:
    ...
    checkout: { title: 'Solicitacoes de fechamento', empty: 'Sem solicitacoes pendentes', table: 'Mesa', amount: 'Valor', discountRate: 'Desconto (%)', finalAmount: 'Valor final', splitResult: 'Resultado da divisao', confirmOnePaid: 'Confirmar pagamento', unfinishedOrders: 'Ainda ha pratos nao concluídos; nao e possivel fechar a mesa', confirmPaid: 'Confirmar pagamento e fechar mesa', processing: 'Processando...', requested: 'Solicitado', paid: 'Pago' },
