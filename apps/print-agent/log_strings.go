...
func logStringsZH() map[string]string {
	return map[string]string{
		...
		"log_printed_ok":            "已打印：%s → %s（单号 %s，耗时 %s）",
		"log_job_queue_age":         "任务等待：单号 %s，自创建起已 %d 秒",
		"log_job_claimed":           "已认领：单号 %s（processing）",
		"log_bootstrap_runtime_config": "正在拉取云端营业时间/轮询设置…",
		"log_bootstrap_routing_sync":   "正在同步档口映射…",
		"log_bootstrap_phase_done":     "启动阶段完成：%s（%s）",
...
func logStringsEN() map[string]string {
	return map[string]string{
		...
		"log_printed_ok":            "Printed: %s → %s (id %s, took %s)",
		"log_job_queue_age":         "Job wait: id %s, age %ds since created",
		"log_job_claimed":           "Claimed: id %s (processing)",
		"log_bootstrap_runtime_config": "Fetching cloud schedule/poll settings…",
		"log_bootstrap_routing_sync":   "Syncing station mapping…",
		"log_bootstrap_phase_done":     "Bootstrap phase done: %s (%s)",
...
func logStringsPT() map[string]string {
	return map[string]string{
		...
		"log_printed_ok":            "Impresso: %s → %s (id %s, demorou %s)",
		"log_job_queue_age":         "Espera: id %s, idade %ds desde criação",
		"log_job_claimed":           "Reivindicado: id %s (processing)",
		"log_bootstrap_runtime_config": "A obter horário/poll da nuvem…",
		"log_bootstrap_routing_sync":   "A sincronizar mapeamento…",
		"log_bootstrap_phase_done":     "Fase de arranque concluída: %s (%s)",
