      ...
      {loading ? (
        ...
        <>
          <select
            ...
            className="w-full bg-brand-bg border border-brand-border rounded-lg px-3 py-2 text-base text-brand-text focus:outline-none focus:ring-2 focus:ring-brand-gold/40"
          >
