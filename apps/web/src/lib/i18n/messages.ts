...
export const MESSAGES = {
  zh: {
    ...
    checkout: {
      ...
      resumeOrderingConfirmMessage:
        '将作废当前结账方案并解锁点单。本餐次已收款项会保留，再次结账时请人工对齐补收。',
    ...
    bill: {
      ...
      splitPlanLocked: '本餐次已有收款记录，分单方案已锁定，不可更改',
  ...
  en: {
    ...
    checkout: {
      ...
      resumeOrderingConfirmMessage:
        'This cancels the current checkout plan and unlocks ordering. Collections already recorded stay on the ledger — align top-ups manually on the next checkout.',
  ...
  pt: {
    ...
    checkout: {
      ...
      resumeOrderingConfirmMessage:
        'Cancela o plano de fechamento atual e libera novos pedidos. Os valores ja recebidos mantem-se no registo — alinhe complementos manualmente no proximo fechamento.',
