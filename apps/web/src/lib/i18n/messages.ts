...
export const MESSAGES = {
  zh: {
    ...
    orderHistory: {
      ...
      voidItemReasonMessage: '取消后该菜品不再计入账单，请选择原因。',
      voidItemReasonLabel: '取消原因',
      voidItemReasonDetailLabel: '补充说明',
      voidItemReasonDetailPlaceholder: '请简要说明情况（必填）',
      voidItemReasonRequired: '请选择取消原因',
