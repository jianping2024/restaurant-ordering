...
export const MESSAGES = {
  zh: {
    ...
    featureSettings: {
      ...
      billReceiptPrintDesc: '开启后，呼叫结账时会打印预账单，分单结账与整桌结账时会打印分单小票与最终账单。关闭则不生成这些打印任务（厨房单不受影响）。',
  ...
  en: {
    ...
    featureSettings: {
      ...
      billReceiptPrintDesc: 'When enabled, call-for-bill prints a pre-bill; split and full checkout print split receipts and the final bill. When disabled, no print jobs are created (kitchen tickets are unaffected).',
  ...
  pt: {
    ...
    featureSettings: {
      ...
      billReceiptPrintDesc: 'Ativo: pedir conta imprime pre-conta; checkout dividido ou total imprime taloes por pessoa e conta final. Desativado: nao cria tarefas de impressao (taloes de cozinha nao sao afetados).',
