...
export const MESSAGES = {
  zh: {
    ...
    menuManager: {
      ...
      category: '分类',
      categoryCode: '编号（可选）',
      categoryCodeHint: '最多 10 个字符；留空则小票不印此类编号。多级大类用横杠连接。',
    ...
    checkout: {
      ...
      receiptPrinterCurrentNone: '当前：不打印（仍会入队；configure 配好打印机后 20 分钟内可自动出纸）',
      receiptPrinterCurrent: '当前：{label}',
      receiptPrinterCashier: '收银',
      receiptPrinterStationSuffix: '出品档口',
      receiptPrintersEmpty: '暂无可用打印机。请在收银电脑运行 MesaPrintAgent configure 保存配置后刷新本页。',
  ...
  en: {
    ...
    checkout: { title: 'Checkout Requests', empty: 'No pending checkout requests', table: 'Table', amount: 'Amount', discountRate: 'Discount (%)', finalAmount: 'Payable', splitResult: 'Split result', orderItems: 'Table items', orderItemsEmpty: 'No item details', confirmOnePaid: 'Confirm paid', unfinishedOrders: 'There are unfinished dishes; table cannot be closed yet', confirmPaid: 'Confirm payment and close table', processing: 'Processing...', requested: 'Requested', paid: 'Paid', receiptPrinter: 'Print to', receiptPrinterNone: '— Do not print —', receiptPrinterCurrentNone: 'Current: do not print (job queued; prints within 20m after configure maps a printer)', receiptPrinterCurrent: 'Current: {label}', receiptPrinterCashier: 'Cashier', receiptPrinterStationSuffix: 'kitchen station', receiptPrintersEmpty: 'No printers in configure. Map stations in MesaPrintAgent configure, save, then refresh.', receiptPrintersLoading: 'Loading printers…' },
  ...
  pt: {
    ...
    authLogin: { subtitle: 'Entrar no painel do restaurante', email: 'Email', password: 'Senha', login: 'Entrar', noAccount: 'Ainda nao tem conta?', register: 'Criar conta', invalid: 'Email ou senha incorretos', network: 'Erro de rede, tente novamente mais tarde', rateLimited: 'Muitas tentativas, tente mais tarde', rateLimitedWithMinutes: 'Muitas tentativas — tente de novo em cerca de {minutes} minutos', staffDisabled: 'Conta de funcionario desativada', staffIncomplete: 'Conta incompleta — peca ao dono para recriar em Funcionarios' },
    ...
    menuManager: { title: 'Gestao do menu', total: 'Total', items: 'pratos', addItem: 'Adicionar prato', allOn: 'Publicar todos', allOff: 'Ocultar todos', empty: 'Sem pratos nesta categoria', emptyEntireMenu: 'Ainda nao ha pratos no menu', addFirst: 'Adicionar primeiro prato', edit: 'Editar', remove: 'Excluir', modalAdd: 'Adicionar prato', modalEdit: 'Editar prato', icon: 'Icone', ptNameReq: 'Nome em portugues *', enName: 'Nome em ingles', zhName: 'Nome em chines', ptDesc: 'Descricao em portugues', enDesc: 'Descricao em ingles', price: 'Preco (€) *', category: 'Categoria', categoryCode: 'Codigo (opcional)', categoryCodeHint: 'Max. 10 caracteres. Deixe vazio para nao imprimir. Categorias aninhadas separadas por hifen.', categoryCodePlaceholder: 'Opcional', itemCode: 'Codigo do prato (opcional)', itemCodeHint: 'Max. 10 caracteres. Deixe vazio para nao imprimir.', itemCodePlaceholder: 'Opcional', filterDishList: 'Filtrar por categoria', allInTopCategory: 'Todos ({name})', filterAllTypes: 'Todas as categorias (todos os pratos)', itemType: 'Tipo', uncategorized: 'Sem categoria', saveEdit: 'Salvar alteracoes', cancel: 'Cancelar', saveFail: 'Falha ao salvar, tente novamente', ptNameRequired: 'Nome em portugues e obrigatorio', validPrice: 'Informe um preco valido', deleteConfirm: 'Excluir', dishPhoto: 'Foto do prato', dishPhotoHint: 'Opcional. JPG / PNG / WebP / GIF, ate 1MB', pickImage: 'Escolher imagem', removeImage: 'Remover imagem', imageTooLarge: 'A imagem deve ter no maximo 1MB', imageTypeInvalid: 'Apenas JPG, PNG, WebP ou GIF', categoryPrintStation: 'Estacao de impressao predefinida', categoryPrintStationHint: 'Vazio: esta categoria nao imprime talao de estacao (continua no ecran/recibo).', itemPrintStation: 'Substituir estacao (opcional)', itemPrintStationHint: 'Vazio: herda a estacao da categoria.', effectiveStationPrefix: 'Talao de estacao', effectiveStationNone: 'Nenhum (sem talao de estacao)', printStationCategoryNone: 'Sem talao de estacao', printStationItemInherit: 'Usar padrao da categoria', errCategoryCodeDuplicate: 'Codigo da categoria deve ser unico entre irmaos do mesmo nivel', errItemCodeDuplicate: 'Codigo do prato deve ser unico neste restaurante' },
    ...
    checkout: { title: 'Solicitacoes de fechamento', empty: 'Sem solicitacoes pendentes', table: 'Mesa', amount: 'Valor', discountRate: 'Desconto (%)', finalAmount: 'Valor final', splitResult: 'Resultado da divisao', orderItems: 'Itens da mesa', orderItemsEmpty: 'Sem detalhe de itens', confirmOnePaid: 'Confirmar pagamento', unfinishedOrders: 'Ainda ha pratos nao concluídos; nao e possivel fechar a mesa', confirmPaid: 'Confirmar pagamento e fechar mesa', processing: 'Processando...', requested: 'Solicitado', paid: 'Pago', receiptPrinter: 'Imprimir em', receiptPrinterNone: '— Nao imprimir —', receiptPrinterCurrentNone: 'Atual: nao imprimir (entra na fila; imprime em 20m apos mapear impressora)', receiptPrinterCurrent: 'Atual: {label}', receiptPrinterCashier: 'Caixa', receiptPrinterStationSuffix: 'estacao', receiptPrintersEmpty: 'Sem impressoras. Mapeie estacoes no configure do agente, guarde e atualize.', receiptPrintersLoading: 'A carregar impressoras…' },
