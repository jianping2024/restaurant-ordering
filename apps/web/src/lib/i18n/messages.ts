...
export const MESSAGES = {
  zh: {
    ...
    checkout: {
      ...
      discountReasonMessage: '本次收款含折扣，请选择折扣原因后继续。',
  ...
  en: {
    ...
    checkout: {
      ...
      discountReasonMessage: 'This payment includes a discount. Select a reason to continue.',
  ...
  pt: {
    ...
    checkout: {
      ...
      discountReasonMessage: 'Este pagamento inclui desconto. Selecione o motivo para continuar.',
