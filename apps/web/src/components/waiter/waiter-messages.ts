export const WAITER_TEXT = {
  zh: {
    ...
    partyMarkerOnlyHint: '仅看板标记，不影响结账或并台',
  ...
  en: {
    ...
    partyMarkerOnlyHint: 'Board marker only — does not affect checkout or merge',
  ...
  pt: {
    ...
    partyMarkerOnlyHint: 'So marcacao no quadro — nao afeta conta nem uniao',
