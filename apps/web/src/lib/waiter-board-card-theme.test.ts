...
describe('waiter-board-card-theme theme tokens', () => {
  ...
  it('KPI and table cards share mesa-board-shell family; gold face is sole selected fill', () => {
    assert.match(WAITER_BOARD_KPI_TONE_CLASS.rose, /mesa-board-shell-dining/);
  ...
  it('selected face is sole gold-face class without ring; KPI icons use status text tokens', () => {
